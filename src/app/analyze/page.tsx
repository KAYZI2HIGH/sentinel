...
export const mockData: AnalyticsData = {
  ...
  analysis: {
    ...
    riskFactors: [
      {
        ...
        severity: "medium",
        description:
          "The token's mutability introduces potential for undesirable changes",
      ...
      },
      {
        ...
        severity: "medium",
        description:
          "Creator identity is not verified, posing reputation risks",
    ...
    summary:
      "Jupiter (JUP) shows moderate security risks due to its mutability and the unknown identity of its creator, but a safe range liquidity.",
    confidence: 0.7,
  },
};
...
const AnalyticsPage: React.FC<{ data?: AnalyticsData }> = ({
  ...
  return (
    <ScrollArea className="border h-full bg-[#18181B] rounded-xl p-8 ml-2 shadow-sm">
      ...
      <div className="flex justify-between items-start mb-6">
        <div>
          ...
          <p className="text-sm text-gray-400">
            Solana token created {extractedInfo.createdAt} •{" "}
            {formatNumber(extractedInfo.holders)} holders
          </p>
        </div>
        <Button
          variant="outline"
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
                {Object.entries(analysis.categoryScores).map(
                  ([category, score]) => (
                    ...
                    >
                      <div
                        className={`text-lg font-bold ${getTrustScoreColor(
                          score
                        )}`}
                      >
                        {score}%
              ...
              <CardContent className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-mono">
                    {responseData.basicInfo.address.slice(0, 8)}...
                    {responseData.basicInfo.address.slice(-8)}
                  </span>
                </div>
                <div className="flex justify-between">
            ...
            >
              <CardContent className="p-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span
                    className={`text-xl font-bold ${getTrustScoreColor(score)}`}
                  >
                    {score}%
                  </span>
                </div>
